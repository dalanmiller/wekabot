...
for fi in sys.argv[1:]:
    if os.path.isfile(fi):
        ...
        ps1 = subprocess.Popen(['java', '-Xmx4g', '-classpath', CLASSPATH+":/Users/simius/Dropbox/CMU_Class_Files/Text Analytics/distributable/libsvm-3.17/java/libsvm.jar", 'weka.classifiers.functions.LibSVM', "-S", "0", "-K", "0", "-D", "3", "-G", "0.0", "-R", "0.0", "-N", "0.5", "-M", "40.0", "-C", "1.0", "-E", "0.001", "-P", "0.1", "-seed", "1", '-t', fi, '-v', '-i' ], stdout=subprocess.PIPE)
